...
namespace CqrsFramework.Tests.IndexTable
{
    ...
    public class ContainerWriteTest
    {
        ...
        public void WriteOnEmptyWithoutActuallyChangingAnything()
        {
            ...
            var freeList = new IdxFreeList(file.Pages[header.FreePagesList], 4096);
        ...
        public void CreateEmptyLeafInNewTable()
        {
...

            {
                ...
                var leaf = new IdxLeaf(file.Pages[leafPage], 4096);
        ...
        public void AllocateSeveralPages()
        {
            ...
            var freelist = new IdxFreeList(file.Pages[1], 4096);
        ...
        public void CreateLeafWithLongValueInNewTable()
        {
            ...
            }
            {
                var header = new IdxHeader(file.Pages[0], 4096);
                var freelist = new IdxFreeList(file.Pages[header.FreePagesList], 4096);
                var leaf = new IdxLeaf(file.Pages[header.GetTreeRoot(0)], 4096);
                var cell = leaf.GetCell(0);
                var buffer = new byte[IdxOverflow.Capacity(4096) * cell.OverflowLength + cell.ValueLength];
                ...
                {
                    var overflow = new IdxOverflow(file.Pages[overflowPage], 4096);
        ...
        public void AddLongCellToLeaf()
        {
            ...
            file.Pages[2] = NodeBuilder.Leaf(0)
                .AddCell(IdxCell.CreateLeafCell(IdxKey.FromInteger(57), cell0Data, 4096))
                .ToBytes();
            ...
            using (var container = new IdxContainer(file))
            {
                ...
                var cell = IdxCell.CreateLeafCell(IdxKey.FromInteger(857), cell1Data, 4096);
                var overflow = container.CreateOverflow(0);
...

            {
                ...
                var leaf = new IdxLeaf(file.Pages[2], 4096);
                ...
                var overflow = new IdxOverflow(file.Pages[3], 4096);
        ...
        public void SplitLeavesAndAddInterior()
        {
            ...
            for (int i = 0; i < 31; i++)
            {
                ...
                var cell = IdxCell.CreateLeafCell(IdxKey.FromInteger(i), value, 4096);
                cells.Add(cell);
                originalLeafBuilder.AddCell(cell);
            }
            var addedCell = IdxCell.CreateLeafCell(IdxKey.FromInteger(32), ContainerTestUtilities.CreateBytes(random, 116), 4096);
            cells.Add(addedCell);
            ...
            using (var container = new IdxContainer(file))
            {
                ...
                interior.AddCell(IdxCell.CreateInteriorCell(key, leaf2.PageNumber, 4096));
...

            {
                ...
                Assert.AreEqual(4, new IdxHeader(file.Pages[0], 4096).GetTreeRoot(0));
                Assert.AreEqual(3, new IdxFreeList(file.Pages[1], 4096).Length, "Free pages");
                var interior = new IdxInterior(file.Pages[4], 4096);
                ...
                var leaf1 = new IdxLeaf(file.Pages[2], 4096);
                var leaf2 = new IdxLeaf(file.Pages[3], 4096);
        ...
        public void DropOverflowPage()
        {
            ...
            file.Pages[3] = NodeBuilder.Leaf(0).AddCell(IdxCell.CreateLeafCell(IdxKey.FromInteger(5457), longValue, 4096)).ToBytes();
            file.Pages[4] = ContainerTestUtilities.CreateOverflow(0, 116 + IdxOverflow.Capacity(4096), longValue);
